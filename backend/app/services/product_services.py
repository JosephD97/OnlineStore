...
class ProductService:
    ...
    def get_all_products(self) -> ProductResponse:
        ...
        self.product_response = [ProductResponse.model_validate(prod) for prod in products]
        return ProductListResponse(products=self.product_response, total=len(self.product_response))
